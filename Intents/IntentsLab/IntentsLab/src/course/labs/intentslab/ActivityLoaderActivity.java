...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent intStartExplicitActiv = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
		// TODO - Start an Activity using that intent and the request code defined above
		startActivityForResult(intStartExplicitActiv, GET_TEXT_REQUEST_CODE);
	}
	...
	private void startImplicitActivation() {
		...
		Intent intStartImplicAct = new Intent(Intent.ACTION_VIEW, uri);
		...
		chooserIntent = Intent.createChooser(intStartImplicAct, CHOOSER_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE) {
			//Log.i(TAG, "Request code = get text request code");
